...
describe('FindItineraryByUserWithParticipantsUseCase', () => {
  ...
  beforeEach(() => {
    ...
    (findItineraryByUserWithParticipantsUseCase as any).itineraryRepository = mockItineraryRepository; // Asignamos el mock al caso de uso
  });
  ...
  it('should throw an error if there is an issue with the repository', async () => {
    ...
    await expect(findItineraryByUserWithParticipantsUseCase.execute(1))
      .rejects
